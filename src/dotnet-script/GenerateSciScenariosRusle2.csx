...
/// Args[1]: Full path to output folder; e.g. C:\csip\run_20200110\working\scenarios_sci_rusle2
...
IBuildSciModel builder = new SciBuilderRusle2();
...
{
    inputFile = Args[0];
    writePath = $"{Args[1]}\\sci_rusle2_{currentDate}";
}
...
Console.WriteLine($"Generating SCI scenarios using RUSLE2 from {inputFile} to {writePath}");
